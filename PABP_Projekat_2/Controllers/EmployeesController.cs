...
namespace PABP_Projekat_2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            int pageSize = 5;
            var employees = _context.Employees.AsNoTracking().Include(e => e.ReportsToNavigation).AsNoTracking();
            return View(await employees.ToPagedListAsync(pageNumber ?? 1, pageSize));
        }
