...
namespace PABP_Projekat_2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            int pageSize = 5;
            var orders = await _context.Orders.AsNoTracking().Include(o => o.Customer).Include(o => o.Employee).Include(o => o.ShipViaNavigation).ToPagedListAsync(pageNumber ?? 1, pageSize);
            return View(orders);
        }
